function clearAll() {
    ...
    if (imgItem != null) imgItem.remove();
    let jokeItem = document.querySelector(".joke");
    if (jokeItem != null) jokeItem.remove();
    let quoteItem = document.querySelector(".quote");
    if (quoteItem != null) quoteItem.remove();
    let riddleItem = document.getElementById("riddle");
    let riddleAns = document.querySelector(".riddleAns");
    if (riddleItem != null) {
      riddleItem.remove();
      if (riddleAns != null) riddleAns.remove();
    }
  }
  ...
  function showMeme() {
    ...
    randMeme.setAttribute("src", randomMemeUrl);
    let pNode = document.querySelector(".content");
    let addBefElem = document.querySelector(".jokeHead");
    pNode.insertBefore(randMeme, addBefElem);
  ...
  function showJoke() {
    ...
    randJoke.textContent = randomJokeText;
    randJoke.setAttribute("class", "joke");
    let pNode = document.querySelector(".content");
    let addBefElem = document.querySelector(".quoteHead");
    pNode.insertBefore(randJoke, addBefElem);
  }
  ...
  function showQuote() {
    ...
    let randQuote = document.createElement("p");
    let author = document.createElement("p");
    mainElem.appendChild(randQuote);
    randQuote.textContent = randomQuote.quote;
    mainElem.appendChild(author);
    author.textContent = "-" + randomQuote.author;
    mainElem.setAttribute("class", "quote");
    let pNode = document.querySelector(".content");
    let addBefElem = document.querySelector(".riddleHead");
    pNode.insertBefore(mainElem, addBefElem);
  ...
  function showRiddle() {
    ...
    let randRiddle = document.createElement("p");
    randRiddle.textContent = randomRiddle.question;
    randRiddle.setAttribute("id", "riddle");
    let pNode = document.querySelector(".content");
    pNode.appendChild(randRiddle);
    let randRiddleAns = document.createElement("p");
    randRiddleAns.textContent = randomRiddle.answer;
    randRiddleAns.setAttribute("class", "riddleAns");
    randRiddleAns.hidden = true;
    pNode.appendChild(randRiddleAns);
  }
  ...
  function revealAnswers() {
    let riddleAns = document.querySelector(".riddleAns");
    if (riddleAns == null) alert("No Riddle Is Shown");
    if (riddleAns != null && riddleAns.hidden == false)
      alert("The Riddle Answer Is Already Shown");
    if (riddleAns != null && riddleAns.hidden == true) riddleAns.hidden = false;
  }
